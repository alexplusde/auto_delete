...
class rex_cronjob_deleted_phpmailerlogs extends rex_cronjob
{
    ...
    {
        return rex_i18n::msg('deleted_phpmailerlogs_cronjob_name');
    }

    public function getParamFields()
    {
        $fields[] = [
            'label' => rex_i18n::msg('deleted_phpmailerlogs_delete_interval'),
            'name' => 'delete_interval',
            'type' => 'select',
            'options' => [
                'YW' => rex_i18n::msg('deleted_phpmailerlogs_delete_interval_weekly'),
                'YM' => rex_i18n::msg('deleted_phpmailerlogs_delete_interval_monthly'), ],
            'default' => 'YW',
            'notice' => rex_i18n::msg('deleted_phpmailerlogs_delete_interval_notice'),
        ];
